...
router.post("/sub-categorys/delete", subCategory_controller_1.SubCategorysController.deleteSubCategory);
...
router.get("/sub-categorys", subCategory_controller_1.SubCategorysController.getAllSubCategorys);
